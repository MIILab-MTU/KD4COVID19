...
from core.executor.seg_model_trainer import SegModelTrainer3D
from core.utils import helpers

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    # experiment
    parser.add_argument('--exp', type=str, default="exp_lung_seg")
    ...
    parser.add_argument('--feature_extract_clf_csv', type=str,
                        default="/media/zhaochen/data/covid_seg/data/data_sh_all/classification_for_prediction.csv")
    ...
    if args.train:
        ...
        trainer_3d = SegModelTrainer3D(args, sess, input_channel=1, output_channel=1)
